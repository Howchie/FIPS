...
## Code below computes steady-state parameters from McCauley (2024) Appendix
...
mccauley2024_initial_values <- function(pvec, W, Time = 24, t0 = 0, dt_minutes = 1) {
  # unpack
  ...
  c_fun <- function(t) mccauley2024_cfun(t, phi)  # Eq. (6)
